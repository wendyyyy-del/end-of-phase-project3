...
class TaxRecord:
    ...
    def __init__(self, client: Client, income):
    ...
    def create_table(cls):
        """Create the tax_records table if it doesn't exist."""
    ...
    def save(self):
        """Insert this TaxRecord into the database and set its id."""
